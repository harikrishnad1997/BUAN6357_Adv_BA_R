...
Adding required libraries and constants
...
Adding required parameters such as seed value and sample sizes
...
Creating a function which would output the classifications for a given sample size and seed value
...
Running the functions for the given values which we have
...
Printing out the different objects
